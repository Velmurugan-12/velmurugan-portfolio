        ...
        <div className="order-2 md:order-1 flex flex-col text-center md:text-left">
          ...
          <div className="flex items-center justify-between md:justify-start gap-5 p-2 sm:p-4">
            <a
              ...
              className="bg-[#F6CD0A] hover:bg-yellow-300 px-5 py-2 ml-3 rounded transition flex items-center text-center whitespace-nowrap w-[50%] md:w-auto gap-3 font-semibold text-gray-800"
